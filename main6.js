...
function preload(){
    cat1= loadImage("https://i.postimg.cc/7LyfQCdN/download-3-removebg-preview.png");
}
function setup(){
...
function gotResults(results){
    if(results.length>0){
         console.log(results);
         nx=results[0].pose.nose.x-230;
         ny=results[0].pose.nose.y-260;
    }
}
