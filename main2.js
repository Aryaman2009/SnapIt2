...
function preload(){
    cat1= loadImage("https://i.postimg.cc/fRXy32gL/images-removebg-preview-4.png");
}
function setup(){
...
function gotResults(results){
    if(results.length>0){
         console.log(results);
         nx=results[0].pose.nose.x-240;
         ny=results[0].pose.nose.y-350;
    }
}
